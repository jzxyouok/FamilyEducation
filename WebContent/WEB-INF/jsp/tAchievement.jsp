			...
			<div class='p_menu'>
				...
				<div class='p_block'>
					<ul class='nav'>
						...
						<li><a class='p_active'
							href='/FamilyEdu/user/myFamilyEduT/achievement'> <span
							...
							<div class='show'>
								<div class='panel-body'>
									<form accept-charset="UTF-8"
										action="/FamilyEdu/user/myFamilyEduT/achievement/addAchievement"
								...
								<div class='panel-body'>
									...
									<c:forEach var="achievement"
										...
										<form
											action="/FamilyEdu/user/myFamilyEduT/achievement/deleteAchievement"
											method="post">
