                ...
                <td><table width="500" border="0" cellspacing="0" cellpadding="0">
                  <tr style="float: right;margin-right:75px;">
                    <td width="86" height="32" ><i
						...
						<td width="86" height="32"><a class='register-link' href='/FamilyEdu/admin/adminLoginOut'> 注销 </a></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
    ...
    <td height="100%"><table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" style="background-repeat: repeat-x;">
        <tr>
          <td width="175" height="100%" valign="top"><table width="175" height="100%" border="0" cellspacing="0" cellpadding="0" background="images/menu_bg.gif">
              <tr>
                <td height="25"><img src="image/menu_top.gif" width="175" height="25"></td>
              </tr>
              <tr>
                <td  style="background:url(image/menu_bg.gif);" valign="top"><div class="dtree">
					...
					d.add(5,0,'后台管理');
					d.add(501,5,'用户资格审核');
					d.add(50101,501,'教师资格审核','/FamilyEdu/admin/findWaitingValidateTeachers?page=1',"",'page');
					d.add(50102,501,'家长资格审核','/FamilyEdu/admin/findWaitingValidateParents?page=1',"",'page');
              ...
              <tr>
                <td height="31"><img src="image/menu_foot.gif" width="175" height="31"></td>
              </tr>
            </table></td>
          <td><iframe src="/FamilyEdu/admin/findWaitingValidateTeachers?page=1" width="100%" height="100%" frameborder="0" name="page"></iframe></td>
        </tr>
      </table></td>
  </tr>
</table>
