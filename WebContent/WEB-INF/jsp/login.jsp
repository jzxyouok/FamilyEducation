				...
				$.ajax({
					...
					success:function(date){
						if(date=="1"){
							...
							alert("账号或密码错误,请重新输入!");
							location.href ="/FamilyEdu/user/login"
						}
					}
				});	
			});
...
<body>
	<div class='bigbar-header autowidth'>
		<div class='bigbar-wrapper'>
			<h1>
				<a href='/FamilyEdu'> <img alt="家教网" class="bigbar-logo-img"
		...
		<div class='login_main'>
			...
			<div class='right'>
				...
				<div class='login-panel'>
					<form accept-charset="UTF-8" action="/FamilyEdu/user/sign_in"
						...
						<span> 
							...
							href="/FamilyEdu/user/register">未有帐号，立即注册</a></span>
					</form>
