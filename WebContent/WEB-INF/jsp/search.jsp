...
<body>
	<div id='site-nav'>
		<div class='wrapper' id="noUserWrapper">
			<ul class='status-info'>
				<li>
					<div class='main-link-div'>
						<a class='main-link' href='/FamilyEdu/user'> <i
			...
			<ul class='tag-info'>
				<li><a class='login-link' href='/FamilyEdu/user/login'> <i
						class='glyphicon glyphicon-user'></i> 请登录
				</a> <a class='register-link' href='user/register'> 免费注册 </a></li>
			</ul>
		</div>
		<div class='wrapper' id="hasUserWrapper">
			<ul class='status-info'>
				...
				<li>
					<div class='main-link-div'>
						<a class='login-link' href='/FamilyEdu/user/myFamilyEduSelect'>
							个人中心 </a>
					</div>
				</li>
				<li>
			...
			<ul class='tag-info'>
				<li><a class='login-link'
					href='/FamilyEdu/user/myFamilyEduSelect'> <i
				...
				<table class='table'>
					...
					<tr>
						...
						<td align='left'>
							<ul>
								<li id="sPeriod_0" ><a
									href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sPeriod=0&sTeachMethod=${sessionScope.searchTeachMethod}&sGender=${sessionScope.searchGender}" rel="nofollow">全部</a>
								</li>
								<li id="sPeriod_1" class="sPeriod"><a href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sPeriod=1&sGrade=100&sTeachMethod=${sessionScope.searchTeachMethod}&sGender=${sessionScope.searchGender}"
									rel="nofollow">小学</a></li>
								<li id="sPeriod_2" class="sPeriod"><a href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sPeriod=2&sGrade=200&sTeachMethod=${sessionScope.searchTeachMethod}&sGender=${sessionScope.searchGender}"
									rel="nofollow">初中</a></li>
								<li id="sPeriod_3"  class="sPeriod"><a href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sPeriod=3&sGrade=300&sTeachMethod=${sessionScope.searchTeachMethod}&sGender=${sessionScope.searchGender}"
									rel="nofollow">高中</a></li>
							</ul>
							<ul class='grade-div' id="sPeriod1">
								<li id="sGrade_100" class="sGrade"><a
									href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sPeriod=1&sGrade=100&sTeachMethod=${sessionScope.searchTeachMethod}&sGender=${sessionScope.searchGender}" rel="nofollow">全部</a>
								</li>
								<li id="sGrade_1" class="sGrade"><a href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sPeriod=1&sGrade=1&sTeachMethod=${sessionScope.searchTeachMethod}&sGender=${sessionScope.searchGender}"
									rel="nofollow">一年级</a></li>
								<li id="sGrade_2" class="sGrade"><a href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sPeriod=1&sGrade=2&sTeachMethod=${sessionScope.searchTeachMethod}&sGender=${sessionScope.searchGender}"
									rel="nofollow">二年级</a></li>
								<li id="sGrade_3" class="sGrade"><a href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sPeriod=1&sGrade=3&sTeachMethod=${sessionScope.searchTeachMethod}&sGender=${sessionScope.searchGender}"
									rel="nofollow">三年级</a></li>
								<li id="sGrade_4" class="sGrade"><a href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sPeriod=1&sGrade=4&sTeachMethod=${sessionScope.searchTeachMethod}&sGender=${sessionScope.searchGender}"
									rel="nofollow">四年级</a></li>
								<li id="sGrade_5" class="sGrade"><a href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sPeriod=1&sGrade=5&sTeachMethod=${sessionScope.searchTeachMethod}&sGender=${sessionScope.searchGender}"
									rel="nofollow">五年级</a></li>
								<li id="sGrade_6" class="sGrade"><a href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sPeriod=1&sGrade=6&sTeachMethod=${sessionScope.searchTeachMethod}&sGender=${sessionScope.searchGender}"
									rel="nofollow">六年级</a></li>
								
							</ul>
							<ul class='grade-div' id="sPeriod2">
								<li id="sGrade_200" class="sGrade"><a
									href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sPeriod=2&sGrade=200&sTeachMethod=${sessionScope.searchTeachMethod}&sGender=${sessionScope.searchGender}" rel="nofollow">全部</a>
								</li>
								<li id="sGrade_7" class="sGrade"><a href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sPeriod=2&sGrade=7&sTeachMethod=${sessionScope.searchTeachMethod}&sGender=${sessionScope.searchGender}"
									rel="nofollow">初一</a></li>
								<li id="sGrade_8" class="sGrade"><a href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sPeriod=2&sGrade=8&sTeachMethod=${sessionScope.searchTeachMethod}&sGender=${sessionScope.searchGender}"
									rel="nofollow">初二</a></li>
								<li id="sGrade_9" class="sGrade"><a href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sPeriod=2&sGrade=9&sTeachMethod=${sessionScope.searchTeachMethod}&sGender=${sessionScope.searchGender}"
									rel="nofollow">初三</a></li>
								
							</ul>
							<ul class='grade-div' id="sPeriod3">
								<li id="sGrade_300" class="sGrade"><a
									href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sPeriod=3&sGrade=300&sTeachMethod=${sessionScope.searchTeachMethod}&sGender=${sessionScope.searchGender}" rel="nofollow">全部</a>
								</li>
								<li id="sGrade_10" class="sGrade"><a href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sPeriod=3&sGrade=10&sTeachMethod=${sessionScope.searchTeachMethod}&sGender=${sessionScope.searchGender}"
									rel="nofollow">高一</a></li>
								<li id="sGrade_11" class="sGrade"><a href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sPeriod=3&sGrade=11&sTeachMethod=${sessionScope.searchTeachMethod}&sGender=${sessionScope.searchGender}"
									rel="nofollow">高二</a></li>
								<li id="sGrade_12" class="sGrade"><a href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sPeriod=3&sGrade=12&sTeachMethod=${sessionScope.searchTeachMethod}&sGender=${sessionScope.searchGender}"
						...
						<td>
							<ul>
								<li id="sGender_0" class="sGender"><a
									href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sGender=0&sTeachMethod=${sessionScope.searchTeachMethod}&sPeriod=${sessionScope.searchPeriod}&sGrade=${sessionScope.searchGrade}" rel="nofollow">全部</a>
								</li>
								<li id="sGender_1" class="sGender"><a href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sGender=1&sTeachMethod=${sessionScope.searchTeachMethod}&sPeriod=${sessionScope.searchPeriod}&sGrade=${sessionScope.searchGrade}"
									rel="nofollow">男</a></li>
								<li id="sGender_2" class="sGender"><a href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sGender=2&sTeachMethod=${sessionScope.searchTeachMethod}&sPeriod=${sessionScope.searchPeriod}&sGrade=${sessionScope.searchGrade}"
									rel="nofollow">女</a></li>
							</ul>
						</td>
					</tr>
						...
						<td>
							<ul>
								<li id="sTeachMethod_0" class="sTeachMethod"><a
									href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sTeachMethod=0&sGender=${sessionScope.searchGender}&sPeriod=${sessionScope.searchPeriod}&sGrade=${sessionScope.searchGrade}" rel="nofollow">全部</a>
								</li>
								<li id="sTeachMethod_1" class="sTeachMethod"><a href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sTeachMethod=1&sGender=${sessionScope.searchGender}&sPeriod=${sessionScope.searchPeriod}&sGrade=${sessionScope.searchGrade}"
									rel="nofollow">一对一上门教授</a></li>
								<li id="sTeachMethod_2" class="sTeachMethod"><a href="/FamilyEdu/user/nav?page=1&keyword=${sessionScope.currentKeyword}&sTeachMethod=2&sGender=${sessionScope.searchGender}&sPeriod=${sessionScope.searchPeriod}&sGrade=${sessionScope.searchGrade}"
						...
						<a
							...
							<div class='course-list-box-left'>
								<div class='course-list-box-left-header'>
									<img alt="家教老师头像" src="${searchResult.createUser.userImage }" />
								</div>
							</div>
						</a>
