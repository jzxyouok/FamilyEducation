			...
			<div class='p_menu'>
				...
				<div class='p_block'>
					<ul class='nav'>
						...
						<li><a class='p_active' href='/FamilyEdu/user/myFamilyEduS/student'> <span
				...
				<div class='p_block'>
					<ul class='nav'>
						...
						<a href='/FamilyEdu/user/myFamilyEduS/order?page=1'> <i
							...
							<div class='show'>
								<div class='panel-body'>
									<form accept-charset="UTF-8"
										action="/FamilyEdu/user/myFamilyEduS/student/addStudent"
													...
													<div class='tpadding'>
														...
														<div class="fields">
															<c:forEach var="student"
																...
																<form
																	action="/FamilyEdu/user/myFamilyEduS/student/deleteStudent"
																	method="post">
